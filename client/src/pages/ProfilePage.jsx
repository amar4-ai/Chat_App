...
const ProfilePage = () => {
  ...
  return (
    <div className='min-h-screen bg-cover bg-[#1e293b] flex items-center
    justify-center'>
      ...
      rounded-lg'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-5 p-10 flex-1'>
          ...
          <input
            ...
            className='p-3 bg-transparent text-white border border-gray-600 rounded-md outline-none focus:outline-none focus:ring-2 focus:ring-violet-500'
          />
          <textarea
