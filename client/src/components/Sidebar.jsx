    ...
    text-white ${selectedUser ? "max-md-hidden" : '' }`}>
            ...
            <div className='flex justify-between items-center'>
                ...
                <div className='relative py-2 group'>
                    ...
                    <div className=' absolute top-full right-0 z-20 w-32 p-5 rounded-md bg-[#282142] border-gray-600 text-gray-100 hidden group-hover:block'>
                        ...
                        <hr className='my-2 borde-t border-gray-500' />
        ...
        <div className='flex flex-col'>
            {userDummyData.map((user, index)=>(
                ...
                key={index}
                className={` relative flex items-center gap-2 p-2 pl-4 rounded cursor-pointer maxx-sm:text-sm ${selectedUser?._id === user._id && 'bg-[#282142]/50'}`}>
